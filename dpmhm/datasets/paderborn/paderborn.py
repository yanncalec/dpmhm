...
```sh
$ tfds build Paderborn --imports dpmhm.datasets.paderborn --manual_dir LOCAL_DIR
```
"""
...
# Merge healthy and artificial set
_SPLIT_PATH_MATCH = {
#   'healthy': ['K001', 'K002', 'K003', 'K004', 'K005', 'K006'],
  'artificial': ['K001', 'K002', 'K003', 'K004', 'K005', 'K006'] + ['KA01', 'KA03', 'KA05', 'KA06', 'KA07', 'KA08', 'KA09', 'KI01', 'KI03', 'KI05', 'KI07', 'KI08'],
        ...
        for file in files:
            ...
            for fp in (path/file).glob('*.mat'):  # do not use `rglob`
                ...
                for dd in np.atleast_1d(dm[fp.name.split('.mat')[0]])[0][2]:
                    xd[dd[0]] = dd[2].astype(_DTYPE.as_numpy_dtype)
